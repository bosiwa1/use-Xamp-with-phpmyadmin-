# use-Xamp-with-phpmyadmin- Apache server locally 
Create a web page using HTML with PHP  and connect it to the Xamp Apache server (use phpmyadmin )
...
7 Now we need to run the Apache server and  MySQL, so go click on  the Manager Server  button, you will see these buttons (MySQL Database and Apache web server )  

8 Run  (MySQL Database and Apache web server  ), just click on both and then click start.
...
12 Create a folder called the PHP folder 

13 open one of the favourite text code editors (IDE)

14 Open your PHP folder in Visual Studio to create your code   

15 Create 3 files inside (connect.php, index.php, search_user.php)

16 Now take this PHP folder to the Xamp folder, that called htdocs, do copy and paste 

(So this will give me a good connection at the server and database running time to locate these 3 files, because it is then the application  )

17to see if your application is running on browsers 
